module.exports = {
  ...
  deploy : {
    development : {
      ...
      'post-deploy': 'git pull && npm install && node_modules/.bin/sequelize db:migrate && npm run build && pm2 reload ecosystem.config.js --env development --update-env --only srl_inventory && pm2 list && pm2 logs --only srl_inventory',
      "env"  : {
        'NODE_ENV': "'development'",
