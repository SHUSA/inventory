module.exports = {
  ...
  deploy : {
    development : {
      ...
      'post-deploy': 'git pull && npm install && npm run build && pm2 reload ecosystem.config.js --env development --update-env && pm2 list && pm2 logs --json',
      // 'post-deploy': 'git pull && pm2 start 0',
      "env"  : {
        'NODE_ENV': "'development'",
