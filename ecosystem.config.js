module.exports = {
  ...
  deploy : {
    development : {
      ...
      'post-deploy': 'git pull && npm install && node_modules/.bin/sequelize db:migrate && npm run build && npm start && pm2 reload ecosystem.config.js --env development --update-env && pm2 list && pm2 logs',
      "env"  : {
        'NODE_ENV': "'development'",
