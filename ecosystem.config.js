module.exports = {
  ...
  deploy : {
    development : {
      ...
      'post-deploy': 'git pull && npm install && npm cache clean --force && npm run build && pm2 reload ecosystem.config.js --env development --update-env && npm start',
      // 'post-deploy': 'git pull && pm2 start all && pm2 list',
      "env"  : {
        'NODE_ENV': "'development'",
